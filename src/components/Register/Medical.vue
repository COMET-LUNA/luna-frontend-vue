...
<template>
  <div class="container ps-5 min-vh-100 d-flex align-items-center">
    <div class="me-5 mt-5">
      ...
      <p>
        Input relevant medical information to assit your doctors.
      ...
      <div class="form-floating mb-3">
        <textarea
          ...
          placeholder="Leave a comment here"
          id="floatingTextarea"
          v-model="state.previousSurgeries"
        ></textarea>
      ...
      <div
        :class="showError ? 'alert alert-danger' : 'alert alert-danger d-none'"
        role="alert"
      >
        {{ errorText }}
      </div>
      <button type="button" class="btn btn-secondary me-3" @click="backPage">
        BACK
      </button>
