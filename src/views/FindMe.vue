...
<template>
  ...
  <div className="row min-vh-100 mx-0">
    <div className='min-vh-100 col-3 pt-5 ps-5 sidebar'>
        ...
        <div class="card-body">
          <h5 class="card-title">Symptoms</h5>
            <div v-if="symptoms.length > 0" v-for="(item, index) in symptoms">
              ...
              <span>{{symptomLocationDict[item.location]}}</span><br />
            </div>
      ...
      <button className="btn btn-secondary rounded-circle show-modal-btn" @click="toggleIntro">?</button>
    </div>
    <div class='col-9 text-start'>
      <Symptom v-if="progressIndex === 0" @add-symptom="addSymptom" @next-page="nextPage" :symptoms="symptoms"/>
      <Preference v-if="progressIndex === 1" @add-pref="addPreference" @next-page="nextPage" @prev-page="prevPage"/>
      <Review v-if="progressIndex === 2" @find-me="findMe" @prev-page="prevPage" :symptoms="symptoms"/>
    </div>
      <div
    role="dialog"
    aria-modal="true"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p>
            You will go through a 3-step process to find your doctor. We will be
            collecting your <b>Symptoms</b> and
          ...
          <p>
            ...
            <b>click any body part</b> that will be shown on the page and a list
            of symptoms will appear. You can
            ...
            <b>'Skins, Joints, and General Symptoms'</b> button for more general
            symptoms.
          </p>
          <p>
            <b class="text-primary">2. Doctor Preferences:</b> You have multiple
            options to narrow down the doctor of their choice such as the
            <b
              >location of the doctor, age, years of experience, consultation
              fee, and gender</b
            >
            of the doctor. These options will match a doctor that is best suited
            for you.
          </p>
          <p>
            <b class="text-primary">3. Doctor List:</b> After, you will be
            served with doctors that match all your preferences, doctors that
            match only your symptoms and locations, and doctors that match your
            symptoms only.
          </p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-primary" @click="toggleIntro">Close</button>
        </div>
      </div>
    </div>
  </div>
