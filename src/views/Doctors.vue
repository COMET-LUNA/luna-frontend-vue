...
onMounted(async() => {
    ...
    if ( symptoms.length == 0 ) {
        ...
        firstRecommendations.value = data.firstRecommendations.sort((a, b) => { return a.name < b.name })
    ...
    <div class="row px-5">
        ...
        <div class="col-9" v-else>
            ...
            <div class="d-flex align-items-center mt-3">
              ...
              <span class='me-3'><span class="badge bg-primary">1st</span> - All preferences and best specialization match</span>
              <span class='me-3'><span class="badge bg-primary">2nd</span> - Only specialization and location preference matched</span>
            </div>
            <div class='mt-4'>
            ...
            <div class='mt-4'>
                ...
                <div v-if="showSpec">
                    <DoctorRow v-for="doctor in specRecommendations" 
                        :doctor="doctor" 
                        :isFirst="false" 
                        :key="doctor.name"
                        @click="showModal(doctor)"
